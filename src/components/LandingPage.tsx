      ...
      <section className={`${styles.aboutus} p-5`}>
        <Row className="gx-0">
          <Col md={12} lg={6}>
            ...
            <p>
              Somos el soporte tanto para consumidores como chaceros en busca de
              reducir los tiempos de atención presencial en las chazas. En esta
              plataforma los clientes podrán realizar sus pedidos a las chazas
              con anticipación y con ello, los chaceros tendrán el espacio
              suficiente para la preparación de estos productos. Con esto
              buscamos reducir la alta demanda en horas pico y los tiempos de
